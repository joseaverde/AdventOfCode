...
-- of all ten unique signal patterns you see, and then write down a single four
...
begin
   ...
   for Input of Input_Data loop
      for Digit of Input.Question loop
         case Get_Count(Digit) is
            when 2 | 4 | 3 | 7 =>  -- '1' | '4' | '7' | '8'
               Count := Count + 1;
            when others => null;
         end case;
      end loop;
